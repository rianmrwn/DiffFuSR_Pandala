...
if __name__ == "__main__":
    ...
    from lightningsr.data.utils import single2tensor, tensor2uint8
    ...
    cv2.imwrite("pt_JPEG_20.png", tensor2uint8(out[0]))
    cv2.imwrite("pt_JPEG_40.png", tensor2uint8(out[1]))
