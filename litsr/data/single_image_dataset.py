...
class SingleImageDataset(data.Dataset):
    def __init__(
        ...
        first_k=None,
        mean=None,
        std=None, multi_spectral=True,channels=4,
        return_img_name=False, raw = False,
    ):

        self.dataset = ImageFolder(
            img_path, repeat=repeat, cache=cache, first_k=first_k,multi_spectral=multi_spectral,channels=channels,
        )
        self.repeat = repeat
