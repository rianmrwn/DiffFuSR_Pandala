...
from fm4cs.utils.constants import EUROSAT_MEANS, EUROSAT_STDS, EUROSAT_SCALED_MEANS, EUROSAT_SCALED_STSDS
from fm4cs.utils.sentinel import (SentinelNormalize, ConsistentRadomHorizontalFlip,
